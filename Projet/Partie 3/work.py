...
class Ui_Form(object):
    ...
    def setupUi(self, Form):
        ...
        self.tabWidget.setMaximumWidth(1200)
...
"}")
        ...
        self.pushButton1 = QtWidgets.QPushButton("►",self.tab_17)
        self.pushButton1.setStyleSheet("color:rgb(252, 55, 49);\n"
"font: 87 15pt \"Aileron Heavy\";\n"
"padding:10px;\n"
"border: 2px solid rgb(252, 55, 49);\n"
"border-radius:20px;")
        self.pushButton1.setObjectName("pushButton1")
        self.pushButton1.setGeometry(1050,600,100,50) 
        self.pushButton1.clicked.connect(self.autre)
    ...
    def autre(self):
        ...
        self.ui = partie3.Ui_Form()
        self.ui.setupUi(self.window)
        self.ui.tp(self.ui.tableView, pd.to_numeric(self.ui.lineEdit_2.text()), pd.to_numeric((self.ui.lineEdit.text())))
        self.window.show()
